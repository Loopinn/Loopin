...
const maxPeople = ref(props.currentPost?.max_people);
const isFull = computed(() => participants.value.length >= maxPeople.value);
...
const buttonStyle = computed(() => {
  if (!authStore.loginUser || isFull.value) {
